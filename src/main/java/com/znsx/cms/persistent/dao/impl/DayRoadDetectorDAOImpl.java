...
/**
 * DayRoadDetectorDAOImpl
 * 
 * @author huangbuji
 *         <p />
 *         Create at 2015-8-31 下午7:13:11
 */
public class DayRoadDetectorDAOImpl extends
		BaseDAOImpl<DayRoadDetector, String> implements DayRoadDetectorDAO {
	@Override
	public DayRoadDetector getLastRecord() {
		Session session = getSession();
		Criteria criteria = session.createCriteria(DayRoadDetector.class);
		criteria.setFirstResult(0);
		criteria.setMaxResults(1);
		criteria.addOrder(Order.desc("dateTime"));
		return (DayRoadDetector) criteria.uniqueResult();
	}
