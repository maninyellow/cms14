...
/**
 * MonthCoviDetectorDAOImpl
 * 
 * @author huangbuji
 *         <p />
 *         Create at 2015-9-7 下午2:57:43
 */
public class MonthCoviDetectorDAOImpl extends
		BaseDAOImpl<MonthCoviDetector, String> implements MonthCoviDetectorDAO {
	@Override
	public MonthCoviDetector getLastRecord() {
		Session session = getSession();
		Criteria criteria = session.createCriteria(MonthCoviDetector.class);
		criteria.setFirstResult(0);
		criteria.setMaxResults(1);
		criteria.addOrder(Order.desc("dateTime"));
		return (MonthCoviDetector) criteria.uniqueResult();
	}
