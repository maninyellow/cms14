...
/**
 * HourCoviDetectorDAOImpl
 * 
 * @author huangbuji
 *         <p />
 *         Create at 2015-9-7 下午2:53:49
 */
public class HourCoviDetectorDAOImpl extends
		BaseDAOImpl<HourCoviDetector, String> implements HourCoviDetectorDAO {
	@Override
	public HourCoviDetector getLastRecord() {
		Session session = getSession();
		Criteria criteria = session.createCriteria(HourCoviDetector.class);
		criteria.setFirstResult(0);
		criteria.setMaxResults(1);
		criteria.addOrder(Order.desc("dateTime"));
		return (HourCoviDetector) criteria.uniqueResult();
	}
